...
<body>
	...
	<%
		...
		if (!author1.equals(author2)) {					// 내가 쓴거 아니면, 업데이트 해라.
				BoardDAO.getInstance().updateHit(idx);		// 이건 DB에서 늘리는거.
				dto.setHit(dto.getHit() + 1);				// 얘는 DB에서 가져온 정보를 똑같이 게시판에도 늘리기위해.
		}
