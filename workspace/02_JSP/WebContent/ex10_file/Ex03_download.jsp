...
<%
	...
	// 바이트 기반 입출력 스트림 사용 (* writer / reader 쓰면 안됨)
	BufferedInputStream bis = new BufferedInputStream(new FileInputStream(file));	// : realPath의 파일 이름을 읽어라.
	...
	// bytes 배열을 응답 처리
	bos.write(bytes, 0, (int)file.length());     // = bos.write(bytes);
