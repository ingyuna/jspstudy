...
<%--
	...
	1. 지시어를 작성해야 한다.
		<%@ 지시어 %>
	2. 다음과 같이 작성한다.
		<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>	-> c = core의 첫 글자를 따서>
...
<body>
	...
	--%>
	<c:set var="name" value="브레드" scope="page" />		<%-- 닫아주는 태그를 생략하기 위해 뒤에 / 슬래쉬를 붙여주면 없어진다. --%>
	...
	<c:set var="address" value="서울시 마포구 서강로" scope="request" />	<%-- 여기서는 scope 생략하면 X --%>
