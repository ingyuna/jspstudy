DROP TABLE REPLY;	-- 외래키가 있는걸 먼저 지워야하니까 REPLY가 먼저 오게 한다.
DROP TABLE BOARD;	
...
-- 데이터
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVALUE, 'admin', '1111', '제임스', 'admin@home.com', SYSDATE);
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVALUE, 'jack', '1111', '잭', 'jack@home.com', SYSDATE);
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVALUE, 'apple', '1111', '사과', 'apple@home.com', SYSDATE);
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVALUE, 'rose', '1111', '장미', 'rose@home.com', SYSDATE);
INSERT INTO MEMBER VALUES (MEMBER_SEQ.NEXTVALUE, 'prodo', '1111', '프로도', 'prodo@home.com', SYSDATE);
