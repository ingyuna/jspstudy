...
public class Quiz05_1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setCharacterEncoding("utf-8");	// 여기서 한번 더 인코딩을 해준다.
		...
		response.sendRedirect("/01_SERVLET/Quiz05_2?name=" + URLEncoder.encode(name, "utf-8") + "&age=" + age);  // 이건 새로운 파라미터 (새로운 request(요청) 
